...
export default function FlashOverlay({ alert, onDone }) {
  const cfg = THREAT_CONFIG[alert?.threat_level] || THREAT_CONFIG.HIGH;
  ...
  return (
    <div
      style={{
        ...
        background: `radial-gradient(ellipse at center, ${cfg.color}28 0%, #00000090 70%)`,
    ...
    >
      ...
      <div style={{
        ...
        ⚠ {alert.threat_level}<br/>THREAT DETECTED
      </div>
